...
#define UI_WIDGET_COOKWORK_Button1              ((button_t*)gui_context_find_widget(2))
#define UI_WIDGET_COOKWORK_Button2              ((button_t*)gui_context_find_widget(3))
#define UI_WIDGET_COOKWORK_Button3              ((button_t*)gui_context_find_widget(4))
#define UI_WIDGET_COOKWORK_ProgressBar1         ((progress_t*)gui_context_find_widget(5))
#define UI_WIDGET_COOKWORK_ArtText1             ((imagetext_t*)gui_context_find_widget(6))
