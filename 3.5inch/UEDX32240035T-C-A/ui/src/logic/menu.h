...
#define UI_WIDGET_MENU_Button1              ((button_t*)gui_context_find_widget(3))
#define UI_WIDGET_MENU_Button2              ((button_t*)gui_context_find_widget(2))
...
#define UI_WIDGET_MENU_Image2               ((image_t*)gui_context_find_widget(8))
#define UI_WIDGET_MENU_Image1               ((image_t*)gui_context_find_widget(9))
