...
#define UI_WIDGET_COFFE_Button3              ((button_t*)gui_context_find_widget(8))
#define UI_WIDGET_COFFE_Button4              ((button_t*)gui_context_find_widget(4))
#define UI_WIDGET_COFFE_ArtText1             ((imagetext_t*)gui_context_find_widget(5))
#define UI_WIDGET_COFFE_ArtText2             ((imagetext_t*)gui_context_find_widget(6))
#define UI_WIDGET_COFFE_ProgressBar1         ((progress_t*)gui_context_find_widget(7))
#define UI_WIDGET_COFFE_ProgressBar2         ((progress_t*)gui_context_find_widget(9))
